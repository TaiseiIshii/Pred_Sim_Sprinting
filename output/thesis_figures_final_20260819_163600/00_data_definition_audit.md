...
- **N=50 と N=100 は純粋なメッシュ収束ではない**（N=100 全wide 基準 −7.987、N=50 は wide+standard 混在 基準 −7.4626、0.524° シフト）。本図集は **N=100 のみを主結果**とし、Fig S4（同系列 N50–N100 比較）は**条件系列を揃えられないため作成中止**（03 参照）。
